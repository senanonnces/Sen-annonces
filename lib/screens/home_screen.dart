...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: IndexedStack(
        index: _currentIndex,
        children: [_buildHome(), _buildFavorites(), _buildProfile()],
      ),
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          ...
          children: [
            IconButton(
              icon: Icon(Icons.home, color: _currentIndex == 0 ? const Color(0xFF00853F) : Colors.grey),
              onPressed: () => setState(() => _currentIndex = 0),
            ),
            IconButton(
              icon: Icon(Icons.favorite_border, color: _currentIndex == 1 ? const Color(0xFF00853F) : Colors.grey),
              onPressed: () => setState(() => _currentIndex = 1),
            ),
            const SizedBox(width: 48),
            IconButton(
              icon: Icon(Icons.person_outline, color: _currentIndex == 2 ? const Color(0xFF00853F) : Colors.grey),
      ...
      slivers: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (_selectedCity != null && _selectedCity != 'Toutes')
                      Chip(
                        label: Text(_selectedCity!, style: const TextStyle(fontSize: 11)),
        ...
        _loadingAds
            ? const SliverFillRemaining(
                child: Center(child: CircularProgressIndicator(color: Color(0xFF00853F))))
            : SliverList(
                delegate: SliverChildBuilderDelegate(
                  (_, i) => _buildAdCard(_filteredAds[i]),
  ...
  Widget _buildAdCard(Map<String, dynamic> ad) {
    return GestureDetector(
      onTap: () => Navigator.push(
          context, MaterialPageRoute(builder: (_) => AdDetailScreen(ad: ad))),
      child: Container(
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(ad['icon'] as IconData? ?? Icons.image,
                  size: 40, color: ad['color'] as Color? ?? Colors.grey),
            ),
            Expanded(
              child: Padding(
